...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  /** Enable the WakeUp
  */
  if (HAL_RTCEx_SetWakeUpTimer_IT(&hrtc, 9, RTC_WAKEUPCLOCK_CK_SPRE_16BITS, 0) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_RTCEx_WakeUpTimerEventCallback(RTC_HandleTypeDef *hrtc)
{
    ...
    {
        // Apagar el timer para no generar múltiples interrupciones
        HAL_RTCEx_DeactivateWakeUpTimer(hrtc);

        // Restaurar el sistema (reconfigurar reloj)
        SystemClock_Config();

        // Cambiar el estado o hacer algo al despertar
        devState = IDLE;
    }
}
